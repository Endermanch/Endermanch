...
I primarily code in **C/C++** as a hobby and work as a **full-stack developer** officially. However, I'm mostly known for my expertise in Windows at an unusually sophisticated low level. 🛠

I have over 300K subscribers on [YouTube](https://youtube.com/endermanch) and more than 15K followers on [Twitter](https://twitter.com/endermanch). You can call me Andrew, even though I am [Enderman](https://enderman.ch).

<img align="right" alt="Enderman" width="180" src="https://github.com/Endermanch/Endermanch/blob/main/enderman.gif" />

* 📚 Maths/CompSci lecturer *(also a CompSci student)*
* 🐱‍💻 Middle low-level developer
* 🗜 Junior full-stack engineer
* 📸 Hobbyist semi-popular YouTuber
* 💾 Malware preservationist/historian
* 🦟 Current owner of YouAreAnIdiot and HURR-DURR JavaScript trojans
* ♟ GM Candidate

I also enjoy plenty of other activities, and sometimes I wish there were 48 hours in a day. Life's short, and I try to make it enjoyable for myself and other nice people around me.

### What's the project you're most proud of?
I have several projects I'm proud of, especially my videos. Here are a few that I personally enjoyed the most:
...
*This README file is best viewed on Windows 10*
